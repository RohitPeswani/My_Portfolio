      ...
      <div className="max-w-screen-lg mx-auto lg:px-20 xl:px-28 ">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:p-0">
          {cards.map(({id, img, color, title}) => {
            return (
              <div className={`shadow-md rounded-lg p-2 md:p-4`} style={{ boxShadow: `0 4px 6px -1px ${color}, 0 2px 4px -1px ${color}` }} key={id}>
                <img
                  src={img}
                  className="h-24 md:h-32 w-full object-contain hover:scale-105 duration-300"
                ></img>
